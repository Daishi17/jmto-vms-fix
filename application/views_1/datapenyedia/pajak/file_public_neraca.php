<script>
    ...
    function tahun_awal_edit() {
        var tahun_mulai_edit = $('[name="tahun_mulai_edit"]').val()
        var tahun_plus_edit = parseInt(tahun_mulai_edit) + 1;
        $('[name="tahun_selesai_edit"]').val(tahun_plus_edit)
    }
</script>