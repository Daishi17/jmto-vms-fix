<script>
    $(document).ready(function() {
        ...
        }).buttons().container().appendTo('#get_data_tender .col-md-6:eq(0)');
    });
    ...
    $(document).ready(function() {
        ...
        }).buttons().container().appendTo('#tbl_tender_terbatas .col-md-6:eq(0)');
    });
    ...
    $(document).ready(function() {
        ...
        }).buttons().container().appendTo('#tbl_tender_penunjukan_langsung .col-md-6:eq(0)');
    });
