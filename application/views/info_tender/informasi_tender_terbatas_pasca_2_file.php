            ...
            <div class="card border-dark">
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            <th>Dokumen Pengadaan Dan Dokumen Kualifikasi</th>
                            <th>
                                <div class="row">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td scope="row"><?= $i++ ?></td>
                                                                            <td><?= $value['nama_dok_pengadaan'] ?></td>
                                                                            <td><a href="<?= $url_dok_pengadaan . $value['file_dok_pengadaan'] ?>" class="btn btn-sm btn-danger"><i class="fas fa fa-file"></i> Download</a></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
