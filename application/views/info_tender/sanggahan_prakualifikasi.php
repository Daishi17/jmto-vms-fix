...
<input type="hidden" name="url_open_sanggahan_pra_panitia" value="https://eprocurement.jmto.co.id/file_paket/<?= $rup['nama_rup'] ?>/">
            ...
            <div class="card" style="position: fixed; top:100px;z-index:999;width:85%;">
                <div class="card-header bg-white text-black">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <small>
                                <a class="nav-link active" style="margin-left: 5px;" href="<?= base_url('tender_diikuti/sanggahan_prakualifikasi/'  . $rup['id_url_rup']) ?>"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Sanggahan Kualifikasi</a>
                            </small>
                        </li>
                        ...
                        <li class="nav-item">
                            <small>
                                <a class="nav-link nav-link bg-primary text-white " style="margin-left: 5px;" href="<?= base_url('tender_diikuti/sanggahan_akhir/'  . $rup['id_url_rup']) ?>"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Sanggahan Pemenang </a>
                            </small>
                        </li>
                    </ul>
                </div>
